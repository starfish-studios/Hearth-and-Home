//package com.starfish_studios.hearth_and_home.util.block;
//
//import com.starfish_studios.hearth_and_home.Mod;
//import com.starfish_studios.hearth_and_home.registry.ModRegistry;
...
//
//        Mod.LOGGER.info("Initialized color sets in {}ms", sw.elapsed().toMillis());
//    }
//
...
//                        new ResourceLocation(ModRegistry.isForge() ? "forge" : "c", id.getPath() + "s")));
//            }
//            if (v.isPresent()) {
//                var tag = v.get();
